...
const db = {
    blogs: {
        1: {
            title: "Signed Query は GraphQL の Trusted Document の新しい実装パターンです",
            author: "YutaUra",
        ...
        4: {
            title: "Developers Summit 2023 SummerでADRについて発表しました & ベストスピーカー賞を受賞しました🎉",
            author: "highwide",
        ...
        5: {
            title: "GraphQL Type Mergingを利用したサブスキーマをまたがった宣言的スキーマ定義",
            author: "highwide",
        ...
        6: {
            title: "〜その意思決定を刻め〜「アーキテクチャ・デシジョン・レコード(ADR)」を利用した設計の記録",
            author: "highwide",
        ...
        7: {
            title: "縦書き学習コンテンツを実現する際に利用した縦書き CSS プロパティとその奥深さ",
            author: "indigolain",
...
const resolvers = {
    ...
    Mutation: {
        ...
        likePost: (_, args) => {
            db.blogs[args.postId].likeUsers = Array.from(new Set([...db.blogs[args.postId].likeUsers, args.userId]));
